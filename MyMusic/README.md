...
2. A busca deve ser realizada através do nome de artist e nome da música.
...
4. A busca deve retornar valores contendo o filtro, não necessitando de ser informado o nome
   completo de música ou artist.
5. O retorno deve estar ordenado pelo nome do artist e depois pelo nome da música. 
